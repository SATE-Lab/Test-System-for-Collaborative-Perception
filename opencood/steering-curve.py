...
def model_predict(model_name):
    ...
    if model_name != '4':
        ...
        png_name_list, test_data = carla_load_steering_data(test_steering_log)
...
def main():
    files_process('/home/chenwei/opencood/OpenCOOD/opencood/models/v2vnet/vis','.png')
    return
...
if __name__ == '__main__':
    model = sys.argv[1]
    arrow_type = sys.argv[2]
    model_predict(model)
    generate_arrowed_pics('./scenario_runner-0.9.13/_out/', 'predict_result', arrow_type)
    ...
    # parser.add_argument('--type', choices=['ori_gif'], default='ori_gif')
    # # parser.add_argument('--name', type=str, default='')
    # args = parser.parse_args()
    # # seed_name = args.name.split('.')[0]
